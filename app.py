...
# ---------- SVG icons for cards (base64 data URIs for reliable iframe rendering) ----------
import base64 as _b64

def _svg_img(svg: str, w: int = 18, h: int = 18) -> str:
    enc = _b64.b64encode(svg.encode()).decode()
    return f'<img src="data:image/svg+xml;base64,{enc}" width="{w}" height="{h}" style="display:block;" />'

_ICON_SPOTIFY = _svg_img(
    ...
    '-.18-.601.18-1.2.72-1.381 4.26-1.26 11.28-1.02 15.721 1.621.539.3'
    '.719 1.02.419 1.56-.299.421-1.02.599-1.559.3z"/></svg>'
)

_ICON_YOUTUBE = _svg_img(
    '<svg viewBox="0 0 24 17" fill="#FF0000" xmlns="http://www.w3.org/2000/svg">'
    '<path d="M23.495 2.205a3.02 3.02 0 0 0-2.122-2.122C19.505 0 12 0 12 0'
    'S4.495 0 2.627.083A3.02 3.02 0 0 0 .505 2.205C0 4.073 0 8 0 8s0 3.927'
    '.505 5.795a3.02 3.02 0 0 0 2.122 2.122C4.495 16 12 16 12 16s7.505 0 '
    '9.373-.505a3.02 3.02 0 0 0 2.122-2.122C24 11.927 24 8 24 8s0-3.927'
    '-.505-5.795zM9.545 11.636V4.364L15.818 8l-6.273 3.636z"/></svg>',
    w=20, h=14,
)

_ICON_TICKET = _svg_img(
    '<svg viewBox="0 0 24 24" fill="none" stroke="#C44D2B" stroke-width="2"'
    ' stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">'
    '<path d="M15 5v2M15 11v2M15 17v2M5 5h14a2 2 0 012 2v3a2 2 0 000 4v3'
    'a2 2 0 01-2 2H5a2 2 0 01-2-2v-3a2 2 0 000-4V7a2 2 0 012-2z"/></svg>'
)

_ICON_CALENDAR = _svg_img(
    '<svg viewBox="0 0 24 24" fill="none" stroke="#2D5F8A" stroke-width="2"'
    ' stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">'
